...
@AnalyzeClasses(packagesOf = EcommercereactApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(EcommercereactApp.class), alwaysTrue())
